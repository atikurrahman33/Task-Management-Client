...
import img from '../../../assets/Task Management-logos_black.png'
            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="text-lg font-bold hidden md:block">Task<span className="text-orange-600">Management</span></p>
